...
if(isset($_POST) & !empty($_POST)){
	$email = mysqli_real_escape_string($db, $_POST['admiEmail']);
	$password = $_POST['admiPassword'];
	$sql = "SELECT * FROM administrator WHERE admiEmail='$email' AND admiPassword='$password'";
	$result = mysqli_query($db, $sql) or die(mysqli_error($db));
	$count = mysqli_num_rows($result);
	if($count == 1){
		//echo "User exits, create session";
		$_SESSION['admiEmail'] = $email;
							...
							<div class="row">
								<div class="form-group">
									<div class="col-md-12">
										...
										<input type="email" name="admiEmail" value="" class="form-control">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="form-group">
									<div class="col-md-12">
										...
										<input type="password" name="admiPassword" value="" class="form-control">
									</div>
								</div>
							</div>
							<div class="clearfix space20"></div>
