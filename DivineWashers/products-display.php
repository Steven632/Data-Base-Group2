        ...
        <div class="row">
            ...
            <div class="col-sm-10 bg-light">
               ...
               <?php     
                            ...
                            // $db = mysqli_connect('localhost', 'root', '', 'divinewashersfinal.sql');
                            include('connection.php');
                            $query = "SELECT COUNT(*) AS productID FROM product";
                  ...
                  <tbody>
                    ...
                    <tr>
                      <form  method="post" id="the-form" enctype="multipart/form-data">
                          ...
                          <td><input type="text" class="form-control" name ="product-name" value="<?php echo($row1['prodName']); ?>"></td>
                          <input type="hidden" class="form-control" name ="subcategories" value="<?php echo($row1['subcategory_id']); ?>" readonly>
                          <input type="hidden"  class="form-control" id="pid" name ="pid" value="<?php echo($row1['productID']);  ?>" readonly>
                          <td><input type="text" class="form-control" name ="brand" value="<?php echo($row1['prodBrand']); ?>"></td>
                          <td><input type="number" class="form-control" name ="quantity" value="<?php echo($row1['prodInventory']); ?>"></td>
                          <td><input type="number" class="form-control" name ="price" value="<?php echo($row1['prodPrice']); ?>"></td>
